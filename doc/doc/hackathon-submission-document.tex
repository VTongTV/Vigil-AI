...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \fill[vigilcyan!22] ([xshift=-2cm,yshift=2cm]current page.north east) circle (5.4cm);
...
\vspace{0.5cm}
\fcolorbox{vigilgreen}{vigilgreen!15}{\begin{minipage}{0.92\linewidth}\centering
\vspace{4pt}
{\Large\bfseries\color{vigilgreen} LIVE \& DEPLOYED}\\[6pt]
{\normalsize\color{white!90}This system is running right now. Judges can try it without any setup.}\\[8pt]
{\large\bfseries\color{white} Frontend Dashboard:}\;\;{\normalsize\color{vigilcyan}\url{https://vigil-ai-gules.vercel.app/dashboard}}\\[6pt]
{\large\bfseries\color{white} Backend API Docs:}\;\;{\normalsize\color{vigilcyan}\url{https://vtongtv-vigilai-backend.hf.space/docs}}\\[6pt]
{\small\color{white!70}HuggingFace Spaces (CPU Basic, 16\,GB RAM) + Vercel (CDN) \;\textbullet\; Zero cost, zero GPU required}\\[4pt]
\vspace{4pt}
\end{minipage}}
...
\fcolorbox{vigilgreen}{vigilgreen!10}{\begin{minipage}{0.94\linewidth}
{\bfseries\large\color{vigilgreen} LIVE DEMO — No setup required}\\[6pt]
{\bfseries\color{vigilblue}Frontend:}\;\;\url{https://vigil-ai-gules.vercel.app/dashboard}\\[4pt]
{\bfseries\color{vigilblue}Backend API:}\;\;\url{https://vtongtv-vigilai-backend.hf.space/docs}\\[4pt]
{\small\color{vigilgray}Deployed on HuggingFace Spaces (Docker, CPU Basic, 16\,GB RAM) + Vercel (CDN). Both free tier. Judges: open the dashboard link and try it.}
\end{minipage}}
...
\begin{center}
\fcolorbox{vigilgreen}{vigilgreen!8}{\begin{minipage}{0.94\linewidth}
\vspace{4pt}
...
\hline
Frontend Dashboard & Vercel (CDN) & \url{https://vigil-ai-gules.vercel.app/dashboard} \\
Backend API Docs & HuggingFace Spaces & \url{https://vtongtv-vigilai-backend.hf.space/docs} \\
Source Code & GitHub & \url{https://github.com/VTongTV/Vigil-AI} \\
\hline
\end{tabular}
\vspace{4pt}
\end{minipage}}
...
Most hackathon teams submit a local demo that requires judges to clone a repo, install dependencies, and hope it works on their machine. VigilAI runs in the cloud. A judge opens a URL and the system is live.
